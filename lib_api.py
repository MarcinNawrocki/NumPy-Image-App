...
def binaryzation(np_org_image, threshold, number_of_inters=1): 
    """Perform binaryzation on a given image using specified threshold value

    Arguments:
        np_org_image {NumPy array} -- image for binaryzation
        threshold {[type]} -- binaryzation threshold from range <0,255>
    ...
    #bs.validate_number_of_inters(number_of_inters, binaryzation.__defaults__[-1])
...
def otsu_binaryzation(np_org_image, number_of_inters=1):
    """Perform binaryzation on a given image using a threshold calculate by OTSU method
    ...
    """
    #arguments validation 
    #bs.validate_number_of_inters(number_of_inters, otsu_binaryzation.__defaults__[-1])
    #get threshold calculated by OTSU method
    otsu_threshold = bn.otsuBinaryzation(np_org_image)
    
    return binaryzation(np_org_image, otsu_threshold, number_of_inters)
...
def dilation(np_org_image, struct_elem='rect', size=3, number_of_inters=2): 
    ...
    #binaryzation
    np_image_bin= bn.otsuBinaryzation(images[-1], only_threshold = False)
    processed_inters += 1        
